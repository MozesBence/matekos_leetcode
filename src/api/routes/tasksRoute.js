...
const { getCardInfo, getSpecificCard, getTaskCount, getRandomTask, getTaskWithSearch, getTasksByDifficult,getTaskByThemes, getFilteredTasks,getsimilarTasks,getSolution,submitTask} = require('../controllers/tasksController');
