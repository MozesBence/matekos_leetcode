...
const { getCardInfo, getSpecificCard, getTaskCount, getRandomTask, getTaskWithSearch, getTasksByDifficult,getTaskByThemes, getFilteredTasks} = require('../controllers/tasksController');
