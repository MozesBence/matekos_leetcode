...
module.exports = (sequelize) => {
    ...
    Advertisement_Cards.initializeCards = async () => {
        const items = [
            ...
            {title: "Küldj be feladatos, és tegyél hozzá a közösséghez!",content:"Ha a feladatod, elfogadásra kerül ay adminok által, az oldalon a feladato a teved lesy megjelölve.",button_title:"Feldat beküldése",redirect:"/task-creation"}
        ];
